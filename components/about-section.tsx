...
import { PCBScannerMask } from "./pcb-scanner-mask"
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        {/* ── Terminal header – NO scanner here ─────────────────────────── */}
        <div
        ...
        >
          <div className="inline-block">
            ...
            <div
              className="border border-cosmic-gold/40 rounded-lg p-6 bg-cosmic-black/50"
        ...
        {/* ── Scanner zone: Bio + Work cards ────────────────────────────── */}
        <div
          id="about-scanner-zone"
          className="relative grid lg:grid-cols-5 gap-8"
        
        >
          {/* PCB overlay canvas — sits above everything in this zone */}
          <PCBScannerMask targetId="about-scanner-zone" />
          ...
          >
            <div
              className="p-6 rounded-xl border border-cosmic-gold/20 bg-cosmic-black/50 h-full"
            ...
            >
              ...
              <p className="leading-relaxed text-cosmic-white/80 text-sm">
                As a second-year ECE student at UWaterloo, I build scalable, innovative solutions at
                the intersection of software development, AI, machine learning and embedded systems.
                <br /><br />
                Beyond tech, I enjoy learning about philosophy, cognitive science and astrophysics.
                I published my first short story with Polar Expressions Publishing at age seven. In
                my free time, I practice calligraphy and read dystopian fiction.
              </p>
            </div>
          </div>
