...
const projects = [
  ...
  category: "Embedded Systems",
  description: "Designed and simulated a traffic light controller on an Altera MAX-10 FPGA using a Moore State machine. Implemented combinational and sequential logic using behavioural VHDL for state machines and synchronizers.",
  ...
  category: "Embedded Systems",
  description: "Designed and simulated HVAC system on an Altera MAX-10 FPGA using VHDL and D flip-flops. Utilized Intel Quartus Prime to implement magnitude comparators, multiplexers, adders and shift registers.",
  image: "/images/fpga.jpg",
  tech: ["VHDL", "Intel Quartus Prime"],
    color: "#FFB460",
    demoUrl: "#", 
  ...
  {
    id: 12,
  title: "Smart Navigation Cane for the Visually Impaired",
    category: "Embedded Systems",
  ...
  image: "/images/cane.png",
    tech: ["Arduino", "ESP32-CAM", "Google Text-to-Speech (TTS)", "YOLOv11", "FastAPI", "React"],
    color: "#FFB460",
    demoUrl: "#", 
  ...
  {
    id: 14,
  title: "Personal Portfolio v1 – Space-Themed Developer Portfolio",
    category: "Web Applications",
  ...
  {
    id: 15,
  title: "Personal Portfolio v2 – Cinematic Developer Portfolio",
    category: "Web Applications",
  description: "A cinematic developer portfolio inspired by Interstellar, featuring 3D elements, parallax backgrounds and GPU-optimized animations. The site includes a blog page with dynamic slug-based routing. AI-powered insights are planned to analyze content similarity.",
  image: "/images/v2.png",
